...
def test_extract_memory_markers_journal_single():
    ...
    cleaned, journals, searches, wiki_searches, web_searches, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_journal_stripped_from_response():
    ...
    cleaned, journals, _, _, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_journal_multiple():
    ...
    _, journals, _, _, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_search_single():
    ...
    cleaned, _, searches, _, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_search_multiple():
    ...
    _, _, searches, _, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_wikipedia_single():
    ...
    cleaned, _, _, wiki_searches, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_wikipedia_multiple():
    ...
    _, _, _, wiki_searches, _, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_web_search_single():
    ...
    cleaned, _, _, _, web_searches, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_web_search_multiple():
    ...
    _, _, _, _, web_searches, _, _, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_ha_list():
    ...
    cleaned, _, _, _, _, ha_list, ha_find, ha_state, ha_svc, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_ha_list_domain():
    ...
    _, _, _, _, _, ha_list, _, _, _, _ = extract_memory_markers(text)
    assert len(ha_list) == 1
...
def test_extract_memory_markers_ha_state():
    ...
    _, _, _, _, _, _, _, ha_state, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_ha_service():
    ...
    _, _, _, _, _, _, _, _, ha_svc, _ = extract_memory_markers(text)
    assert len(ha_svc) == 1
...
def test_extract_memory_markers_ha_find():
    ...
    cleaned, _, _, _, _, _, ha_find, _, _, _ = extract_memory_markers(text)
