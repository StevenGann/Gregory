...
def test_extract_memory_markers_journal_single():
    ...
    cleaned, journals, searches, wiki_searches, web_searches = extract_memory_markers(text)
...
def test_extract_memory_markers_journal_stripped_from_response():
    ...
    cleaned, journals, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_journal_multiple():
    ...
    _, journals, _, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_search_single():
    ...
    cleaned, _, searches, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_search_multiple():
    ...
    _, _, searches, _, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_wikipedia_single():
    ...
    cleaned, _, _, wiki_searches, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_wikipedia_multiple():
    ...
    _, _, _, wiki_searches, _ = extract_memory_markers(text)
...
def test_extract_memory_markers_web_search_single():
    ...
    cleaned, _, _, _, web_searches = extract_memory_markers(text)
...
def test_extract_memory_markers_web_search_multiple():
    ...
    _, _, _, _, web_searches = extract_memory_markers(text)
